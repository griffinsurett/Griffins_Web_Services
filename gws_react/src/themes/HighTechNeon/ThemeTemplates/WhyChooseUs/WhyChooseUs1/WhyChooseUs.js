  ...
  const listItems = [
    {
      ...
      description:
        "We understand that tech jargon can be confusing, so we focus on clear, straightforward communication. You can expect us to explain everything in simple terms, ensuring you're comfortable and confident every step of the way.",
    },
    {
      title: "Customized Solutions That Fit Your Needs",
      description:
        "Your business is unique, and we respect that! We create custom solutions that align with your goals and work seamlessly with your current setup, making your life easier without unnecessary changes.",
    },
    {
      title: "Transparency and Honesty",
      description:
        "You’ll never get hidden fees or unexpected surprises. We believe in full transparency, so you’ll always know what’s happening and what you’re paying for. No surprises, just trust.",
    },
    {
      title: "Results That Drive Your Business Forward",
      description:
        "Our goal isn’t just to create a website or app; it’s to help your business succeed. With a focus on your goals, we design solutions that work for your customers and help drive growth.",
    },
    {
      title: "Experienced, Friendly Professionals Who Care",
      description:
        "Our team isn’t just skilled; they’re passionate about helping businesses like yours. You’ll be working with professionals who truly care about your success, ready to guide you with patience and understanding.",
    },
