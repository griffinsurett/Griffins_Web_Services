...
function FAQ() {
  ...
  const faqItems = [
    ...
    {
      title:
        "How does Griffin's Web Services handle security, and what ongoing support is provided?",
      content:
